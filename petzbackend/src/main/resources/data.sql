...
-- Appointment Slots (rolling — day+1 through day+7, safe to re-run)
-- PetCare — Dr. Anita Sharma
INSERT IGNORE INTO appointments (id, hospital_id, doctor_id, appointment_date, appointment_time, end_time, duration_minutes, slot_status, booking_type, version, created_at, updated_at) VALUES
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000002'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000001'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000001'), DATE_ADD(CURDATE(),INTERVAL 1 DAY), '10:00:00','10:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000003'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000001'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000001'), DATE_ADD(CURDATE(),INTERVAL 1 DAY), '14:00:00','14:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000007'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000001'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000001'), DATE_ADD(CURDATE(),INTERVAL 2 DAY), '14:00:00','14:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000060'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000001'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000001'), DATE_ADD(CURDATE(),INTERVAL 3 DAY), '09:00:00','09:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000061'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000001'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000001'), DATE_ADD(CURDATE(),INTERVAL 3 DAY), '14:00:00','14:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
-- PetCare — Dr. Rajiv Mehta
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000005'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000001'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000002'), DATE_ADD(CURDATE(),INTERVAL 1 DAY), '15:00:00','15:45:00', 45,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000062'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000001'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000002'), DATE_ADD(CURDATE(),INTERVAL 2 DAY), '11:00:00','11:45:00', 45,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000063'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000002'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000003'), DATE_ADD(CURDATE(),INTERVAL 2 DAY), '09:00:00','09:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000064'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000002'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000003'), DATE_ADD(CURDATE(),INTERVAL 3 DAY), '14:00:00','14:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000011'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000003'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000004'), DATE_ADD(CURDATE(),INTERVAL 1 DAY), '14:00:00','14:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000065'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000003'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000004'), DATE_ADD(CURDATE(),INTERVAL 2 DAY), '10:00:00','10:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000066'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000003'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000004'), DATE_ADD(CURDATE(),INTERVAL 3 DAY), '10:00:00','10:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000067'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000003'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000005'), DATE_ADD(CURDATE(),INTERVAL 2 DAY), '14:00:00','14:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000068'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000004'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000006'), DATE_ADD(CURDATE(),INTERVAL 3 DAY), '09:00:00','09:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000069'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000004'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000006'), DATE_ADD(CURDATE(),INTERVAL 3 DAY), '14:00:00','14:30:00', 30,'AVAILABLE','ROUTINE',0,NOW(),NOW()),
-- Bangalore Emergency — Dr. Meera Patel
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000070'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000005'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000007'), DATE_ADD(CURDATE(),INTERVAL 2 DAY), '08:00:00','08:30:00', 30,'AVAILABLE','ROUTINE',  0,NOW(),NOW()),
-- Bangalore Emergency — Dr. Rohan Desai
...
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000071'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000005'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000008'), DATE_ADD(CURDATE(),INTERVAL 2 DAY), '10:00:00','10:30:00', 30,'AVAILABLE','ROUTINE',  0,NOW(),NOW()),
(UUID_TO_BIN('ffff0000-0000-0000-0000-000000000072'), UUID_TO_BIN('cccc0000-0000-0000-0000-000000000005'), UUID_TO_BIN('eeee0000-0000-0000-0000-000000000008'), DATE_ADD(CURDATE(),INTERVAL 3 DAY), '10:00:00','10:30:00', 30,'AVAILABLE','ROUTINE',  0,NOW(),NOW());
